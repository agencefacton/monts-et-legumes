...
# salad = Subcategory.create!( name:'Salade', category_id: 6)
# herbs = Subcategory.create!( name:'Herbes aromatiques', category_id: 6)
# flourandcooked = Subcategory.create!( name:'Farine et bocaux', category_id: 8)
# ground = Subcategory.create!( name:'Viande hachée', category_id: 8)
# cow = Subcategory.create!( name:'Fromage de vache', category_id: 10)
# goat = Subcategory.create!( name:'Fromage de chèvre', category_id: 10)
